...
<div id="admin_bar">
  <div id="status">管理员：<%=(String)objvalue%>             &#160;&#160;&#160;&#160; <a href="#">注销</a></div>
  <div id="channel"> </div>
</div>
<div name="cartoondiv" id="main">
  <div id="opt_list">
    <ul>
	  <li><a href="/cartoon_war_exploded/admin/addType.jsp" target="context">添加种类</a></li>
      <li><a href="/cartoon_war_exploded/types.get" target="context">更多种类</a></li>
      <li><a href="/cartoon_war_exploded/admin/addCartoon.jsp" target="context">添加漫画</a></li>
